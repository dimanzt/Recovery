...
#casual destroy
#nodes_dest,edges_dest,nodes_grey,edges_grey
#Diman
#nodes_destroyed,edges_destroyed,nodes_grey,edges_grey=destroy_gray_area(H,0.5)
#destroy_graph_gray(H,29,-95,12,0.9)

#destroy_gray_area(H,0.5)
#Seamus
#nodes_destroyed,edges_destroyed,nodes_grey,edges_grey=destroy_graph_gray(H,29,-95,12,0.5) #per abilene
...
#path_to_gray=write_gray_graph(nodes_grey,edges_grey,filename_graph,path_to_stats)
...
resolve_one_hop_nodes(graph_built, owned_nodes)
#Diman Commented
...
while ( check_routability(graph_built,copy_of_green_edges)==False  ):
    ...
    #Begin Seamus Additions Diman Commented
    ...
    while(pruning_flag==True):
		...
		#Diman
        #only_graph_greyed=nx.MultiGraph(get_graph_from_greyed_graph(temp_graph_supply))
		#Diman
        ...
        if couples_to_prune==None:
			...
			#Diman
            #multiple_paths_to_prune,edges_to_prune=get_multiple_path_no_ramification_to_prune(H,temp_graph_supply,only_graph_greyed,distance_metric)
			#Diman
			...
			#Diman
            #multiple_paths_to_prune,edges_to_prune=get_multiple_path_no_ramification_to_prune_after_split(H,temp_graph_supply,only_graph_greyed,distance_metric,couples_to_prune)
			#Diman
