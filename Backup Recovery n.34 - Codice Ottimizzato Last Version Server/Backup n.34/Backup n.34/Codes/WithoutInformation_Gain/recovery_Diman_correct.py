...
#DIMAN COMMENTED SEAMUS
    ...
    while(pruning_flag==True):
        ...
        my_draw(temp_graph_supply,'AfterOneHopEdge-%d'%(counter_isp))
...
recover_gray_Diman(H,nodes_recovered_isp,edges_recovered_isp,nodes_really_dest, edges_really_dest)
