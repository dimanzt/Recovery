...
while ( check_routability(get_graph_from_destroyed_graph(graph_built),copy_of_green_edges)==False  ):
    ...
    route_g = get_graph_from_destroyed_graph(graph_built)
    my_draw(route_g,'ISP%d_route'%cnt)
    cnt = cnt + 1
    ...
    if counter_starvation>=10:
        ...
        graph_recovered=build_graph_repaired(H,nodes_truely_recovered_isp,edges_truely_recovered_isp)
