...
node_a = pydot.Node("Node A", style="filled", fillcolor="red",pos='10,10!')
...
node_b = pydot.Node("Node B", style="filled", fillcolor="green",pos='10,20!')
node_c = pydot.Node("Node C", style="filled", fillcolor="#0000ff",pos='20,10!')
node_d = pydot.Node("Node D", style="filled", fillcolor="#976856",pos='10,20!')
