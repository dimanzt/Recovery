...
def optimal_recovery_multicommodity(H,green_edges):
    ...
    nodes_used, edges_used=multicommodity_solution(nodes,demand_flows,arcs,capacity,arc_cost,inflow)
...
def multicommodity_solution(nodes,demand_flows,arcs,capacity,arc_cost,inflow):
