...
my_draw(temp_graph_supply_4,'Diman_expected_optimal_%d'%counter)
counter=counter+1
#nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(temp_graph_supply_4,green_edges)
while (routability_flag==False):
  nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(temp_graph_supply_4,green_edges)
  ...
  #nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery_max_flow(temp_graph_supply_4,green_edges)
