...
def destroy_graph_gray(H,mu_x,mu_y,sigma,error):

    nodes_dest,nodes_really_dest=destroy_nodes_gray(H,mu_x,mu_y,sigma,error)
    edges_dest,edges_really_dest=destroy_edges_gray(H,mu_x,mu_y,sigma,error)
...
def destroy_nodes_gray(H,mu_x,mu_y,sigma,error):
...
def destroy_edges_gray(H,mu_x,mu_y,sigma,error):
