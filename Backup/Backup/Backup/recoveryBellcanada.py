...
my_draw(H7, 'really_destroyed_expected_one_shot')
...
green_edges=deepcopy(copy_of_green_edges)
my_draw(H7,'7-destroyed_for_expected_optimal_one_shot')
#calcola recovery ottimo
nodes_recovered_expected_optimal=[]
edges_recovered_expected_optimal=[]
...
routability_flag=False
counter=0
my_draw(temp_graph_supply_3,'Diman_one_shot_expected_optimal_%d'%counter)
max_prob=0
min_prob= 1
counter=counter+1
