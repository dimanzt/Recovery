...
path_to_stats='../../../image_graph_dot/stats/statistiche/'#'C:/Users/user/Novella/image_graph_dot/stats/statistiche/'
#'/usr/local/home/'+user_name+'/Desktop/image_graph_dot/stats/statistiche/'
...
def avarage(name_of_file,filename,path_to_stats):
    ...
    filename=filename[:-4]
    filename='stat_alpha_based'
    path_to_file_to_write=name_directory+'/'+filename+"_Dati_Aggregati"
    print 'QUI SALVO I VALORI CALCOLATI'
    print path_to_file_to_write
