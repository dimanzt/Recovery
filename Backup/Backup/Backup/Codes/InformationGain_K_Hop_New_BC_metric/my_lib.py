...
def Discover_neighbors(H, G, probe_nodes, k, nodes_really_dest ,edges_really_dest,discovered_edges,discovered_nodes,nodes_recovered_isp,edges_recovered_isp,counter_isp):
    ...
    if k > 1:
        for x in range(k-1):
            reveal_edges_status(H,G,discovered_nodes, nodes_really_dest ,edges_really_dest,discovered_edges,discovered_nodes,nodes_recovered_isp,edges_recovered_isp)		
            discovered_nodes,destroyed_nodes=resolve_one_hop_nodes(H, G, discovered_nodes)
